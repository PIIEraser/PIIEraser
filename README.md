...
* **Industry Leading Accuracy:** PII Eraser uses the latest transformer technology to detect [over 60 sensitive entity types](https://docs.piieraser.ai/user-guide/entity-types/). This delivers higher accuracy than legacy regex or ML-based detectors, particularly on real world data that doesn't fit rigid formats or contain PII type descriptors (e.g. "My credit card number is ..").
