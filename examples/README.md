...
* [`/configs`](./configs) - Contains `config.yaml` files demonstrating how to configure PII Eraser for different enterprise scenarios (e.g., M&A deal rooms, legal tech, healthcare, and ASR transcript masking).
